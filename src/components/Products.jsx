        ...
        <div className="container  mx-auto p-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4  gap-4 relative  shadow-md rounded-xl overflow-hidden">
            {products.map((products) => (
              <div key={products.id} className="bg-white rounded-lg border p-4 shadow-md">
                <img
                  src={products.image}
                  alt=""
                ...
                />
                  ...
                  <div className="font-bold text-lg mt-2 text-center">{products.name}</div>
                  <p className="text-gray-700 text-xs text-center mt-1">{products.description}</p>
             
                <div className="text-center mt-3 px-1 py-2  hover:text-blue-500 cursor-pointer">
                  <a
                    href="#"
